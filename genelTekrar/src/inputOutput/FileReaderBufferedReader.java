...
public class FileReaderBufferedReader {
	 ...
	 public static void main(String[] args) {
		 ...
		 // try(Scanner scanner = new Scanner(new FileReader("ogrenciler.txt"))) { file reader da bu şekilde çalışıyor
		 //Buffered reader daha hızlı büyük dosyalarda buffered reader kullanmak daha mantıklı
